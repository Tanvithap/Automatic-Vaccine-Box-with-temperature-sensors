...
public class view_request extends javax.swing.JFrame {
 DefaultTableModel dtab;
    ...
    public view_request() {
        ...
        dtab.addColumn("Request ID");
        dtab.addColumn("User ID");
        dtab.addColumn("Vaaccine Center");
        dtab.addColumn("Date");
        dtab.addColumn("Time");
		...
		System.out.println("Row Clicked:"+row1);
                String rid=dtab.getValueAt(row1, 0).toString();
               String date=dtab.getValueAt(row1, 3).toString();
               
                
                new update_vaccine_status(rid,date).setVisible(true);
                }
        });
        
         
            ArrayList al=db.get_requests();
